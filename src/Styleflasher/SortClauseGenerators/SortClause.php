...
class SortClause
{
    ...
    protected $sortDirection = LocationQuery::SORT_ASC;
    
    public function setSortDirection($direction) {
        switch($direction) {
            
            case LocationQuery::SORT_DESC:
            case 'desc':
                $this->sortDirection = LocationQuery::SORT_DESC;
                break;
            default:
                $this->sortDirection = LocationQuery::SORT_ASC;
